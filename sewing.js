...
Elm.Exts.RemoteData.make = function (_elm) {
   ...
   if (_elm.Exts.RemoteData.values)
   return _elm.Exts.RemoteData.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "Exts.RemoteData",
   ...
   var fromHttp = function (response) {
      return function () {
         switch (response.ctor)
         {case "Just":
            switch (response._0.ctor)
              {case "Failure":
                 return Failed(response._0._1);
                 case "Success":
                 return Answer(response._0._0);
   ...
   var fromJsonHttp = F2(function (decoder,
   response) {
      return function () {
         switch (response.ctor)
         {case "Just":
            switch (response._0.ctor)
              {case "Failure":
                 ...
                 return function () {
                      ...
                      switch (_v10.ctor)
                      {case "Err":
                         return Failed(_v10._0);
                         case "Ok":
                         return Answer(_v10._0);}
                      _U.badCase($moduleName,
   ...
   var map = F2(function (f,d) {
      return function () {
         switch (d.ctor)
         {case "Answer":
            return Answer(f(d._0));
            case "Failed":
            return Failed(d._0);
   ...
   _elm.Exts.RemoteData.values = {_op: _op
                                 ,NotAsked: NotAsked
                                 ,Loading: Loading
                                 ,Failed: Failed
                                 ,Answer: Answer
                                 ,fromHttp: fromHttp
                                 ,fromJsonHttp: fromJsonHttp
                                 ,map: map};
   return _elm.Exts.RemoteData.values;
};
Elm.Exts = Elm.Exts || {};
...
Elm.Exts.SafeList.make = function (_elm) {
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm);
   var pred = F2(function (p,x) {
      return p(x) ? $Maybe.Just(x) : $Maybe.Nothing;
   });
   var may = F2(function (p,f) {
      return function ($) {
         return $Maybe.map(f)(pred(p)($));
      };
   });
   var safeHead = A2(may,
   function ($) {
   ...
   xs) {
      return safeHead(A2($List.filter,
      f,
      xs));
   });
   var tailMaybe = A2(may,
   function ($) {
      return $Basics.not($List.isEmpty($));
   },
   $List.tail);
...
Elm.Exts.String.make = function (_elm) {
   ...
   if (_elm.Exts.String.values)
   return _elm.Exts.String.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   s) {
      ...
      prefix,
      s) ? A2($String.dropLeft,
      $String.length(prefix),
      s) : s;
   });
   _elm.Exts.String.values = {_op: _op
...
Elm.Exts.Tuple.make = function (_elm) {
   ...
   if (_elm.Exts.Tuple.values)
   return _elm.Exts.Tuple.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   _elm.Exts.Tuple.values = {_op: _op
                            ,indexedPair: indexedPair};
   return _elm.Exts.Tuple.values;
};
...
Elm.HtmlUtils.make = function (_elm) {
   "use strict";
   _elm.HtmlUtils = _elm.HtmlUtils || {};
   if (_elm.HtmlUtils.values)
   return _elm.HtmlUtils.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
...
Elm.Json.Decode.Extra.make = function (_elm) {
   ...
   if (_elm.Json.Decode.Extra.values)
...
Elm.Main.make = function (_elm) {
   ...
   var updateFrontPageSettings = function (_v9) {
      return function () {
         switch (_v9.ctor)
         {case "Model":
                      ...
                      {case "Just":
                         switch (_v12._1.ctor)
                           {case "ProductListPage":
                              switch (_v12._1._1.ctor)
                                {case "NoFilter":
                                   return function () {
                                        var newSettings = $Maybe.Just({_: {}
                                                                      ,pageSize: _v12._1._0
                                                                      ,scroll: _v12._0._0.viewportTop});
   ...
   var pageSize = 24;
   var updatePageSize = function (_v18) {
      return function () {
         switch (_v18.ctor)
         {case "Model":
            return $System.Model(function () {
                 ...
                 {case "_Tuple2":
                    switch (_v21._0.ctor)
                      {case "Just":
                         switch (_v21._1.ctor)
                           {case "ProductListPage":
                              return $System.scrolledToBottom(_v21._0._0) ? _U.replace([["view"
   ...
   var persistedStarredProducts = function () {
      var decodeStarred = function (maybeString) {
         return function () {
            switch (maybeString.ctor)
            {case "Just":
               return function () {
                    var _v29 = A2($Json$Decode.decodeString,
                    $Json$Decode.list($Json$Decode.$int),
                    maybeString._0);
                    switch (_v29.ctor)
                    {case "Err": return $Set.empty;
                       case "Ok":
                       return $Set.fromList(_v29._0);}
                    _U.badCase($moduleName,
   ...
   var scrollWatcher = F2(function (_v32,
   scrollWatch) {
      return function () {
         switch (_v32.ctor)
         {case "Model":
            return function () {
                 var newScroll = function () {
                    var _v35 = {ctor: "_Tuple3"
                               ,_0: scrollWatch.view
                               ,_1: _v32._0.view
                               ,_2: _v32._0.frontPageSettings};
                    switch (_v35.ctor)
                    {case "_Tuple3":
                       switch (_v35._0.ctor)
                         {case "ProductListPage":
                            switch (_v35._0._1.ctor)
                              {case "NoFilter":
                                 switch (_v35._1.ctor)
                                   {case "ProductListPage":
                         ...
                         {case "ProductListPage":
                            switch (_v35._1._1.ctor)
                              {case "NoFilter":
                                 switch (_v35._2.ctor)
                                   {case "Just":
                                      return $Maybe.Just(_v35._2._0.scroll);}
                                   break;}
                              break;}
                         switch (_v35._0.ctor)
                         {case "ProductPage":
   ...
   var decodeHash = function (hash) {
      return function () {
         ...
         "#/uncategorised") ? A2($System.ProductListPage,
         pageSize,
         $System.FilterNoCategory) : _U.eq(hash,
         "#/unbranded") ? A2($System.ProductListPage,
         pageSize,
         $System.FilterNoBrand) : A2($String.startsWith,
         categoryPrefix,
         ...
         productPrefix,
         hash) ? function () {
            var _v49 = $Json$Decode.decodeString($Json$Decode.$int)(A2($Exts$String.removePrefix,
            productPrefix,
            hash));
            switch (_v49.ctor)
            {case "Err":
               ...
               case "Ok":
               return $System.ProductPage(_v49._0);}
            _U.badCase($moduleName,
                 ...
                 {case "ChangeCurrentPageUrl":
                    ...
                    return function () {
                         var newView = function () {
                            var _v66 = {ctor: "_Tuple2"
                                       ,_0: _v52._0.frontPageSettings
...
Elm.Schema = Elm.Schema || {};
Elm.Schema.make = function (_elm) {
   "use strict";
   _elm.Schema = _elm.Schema || {};
   if (_elm.Schema.values)
   return _elm.Schema.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $Basics = Elm.Basics.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   $Exts$Tuple = Elm.Exts.Tuple.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   ...
   var decodeCategory = A2($Json$Decode$Extra.apply,
   A2($Json$Decode.map,
   Category,
   A2($Json$Decode._op[":="],
   "categoryId",
   ...
   var decodeImage = A2($Json$Decode$Extra.apply,
   ...
   var decodeBrand = A2($Json$Decode$Extra.apply,
   A2($Json$Decode.map,
   Brand,
   A2($Json$Decode._op[":="],
   "brandId",
   ...
   var decodeDataFeed = A2($Json$Decode$Extra.apply,
   A2($Json$Decode$Extra.apply,
   A2($Json$Decode.map,
   DataFeed,
   A2($Json$Decode._op[":="],
   ...
   A2($Json$Decode.map,
   function ($) {
      return $Dict.fromList($List.map($Exts$Tuple.indexedPair(function (_) {
         return _.brandId;
      }))($));
   },
   $Json$Decode.list(decodeBrand)))),
   A2($Json$Decode._op[":="],
   "categories",
   A2($Json$Decode.map,
   function ($) {
   ...
   $Json$Decode.list(decodeCategory)))),
   A2($Json$Decode._op[":="],
   "products",
   ...
   _elm.Schema.values = {_op: _op
                        ...
                        ,Image: Image
                        ,Category: Category
                        ,decodeDataFeed: decodeDataFeed
                        ,decodeBrand: decodeBrand
                        ,decodeCategory: decodeCategory
                        ,decodeImage: decodeImage
                        ,decodeProduct: decodeProduct};
   return _elm.Schema.values;
};
Elm.Set = Elm.Set || {};
...
Elm.System.make = function (_elm) {
   ...
   var ChangeCurrentPageUrl = function (a) {
   ...
   var BuyProduct = function (a) {
      return {ctor: "BuyProduct"
             ,_0: a};
   };
   var ShareProduct = F2(function (a,
   b) {
      return {ctor: "ShareProduct"
             ,_0: a
             ,_1: b};
   });
   ...
   var ChangeDataFeed = function (a) {
      return {ctor: "ChangeDataFeed"
             ,_0: a};
   };
   var NoOp = {ctor: "NoOp"};
   var Twitter = {ctor: "Twitter"};
   ...
   var FilterWithCategoryId = function (a) {
      return {ctor: "FilterWithCategoryId"
             ,_0: a};
   };
   var FilterWithIds = function (a) {
   ...
   var FilterNoCategory = {ctor: "FilterNoCategory"};
   var FilterNoBrand = {ctor: "FilterNoBrand"};
   var FilterStarred = {ctor: "FilterStarred"};
   var NoFilter = {ctor: "NoFilter"};
   _elm.System.values = {_op: _op
                        ,NoFilter: NoFilter
                        ,FilterStarred: FilterStarred
                        ,FilterNoBrand: FilterNoBrand
...
Elm.Uri = Elm.Uri || {};
Elm.Uri.make = function (_elm) {
   "use strict";
   _elm.Uri = _elm.Uri || {};
   if (_elm.Uri.values)
   return _elm.Uri.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
...
Elm.View.make = function (_elm) {
         ...
         {case "Model":
            return A2($Html.div,
              ...
              _L.fromArray([$Html.text(A2($Basics._op["++"],
                           ...
                           "FPS: ",
                           $Basics.toString(_v0._0.frontPageSettings)))
                           ,A2($Html.br,
                           _L.fromArray([]),
                           _L.fromArray([]))
                           ,$Html.text(A2($Basics._op["++"],
   ...
   dataFeed) {
      return function () {
         var productCount = $List.length(A3($System.filterProducts,
         starredProducts,
         productFilter,
         dataFeed.products));
...
Elm.ViewCommon.make = function (_elm) {
   ...
   _L.fromArray([]))]));
   var buyButton = F2(function (uiChannel,
   p) {
      return A2($Html.a,
      _L.fromArray([$Html$Attributes.href(p.clickUrl)
                   ,$Html$Attributes.$class("btn btn-sm btn-success")
                   ,$Html$Events.onClick($Signal.send(uiChannel)($System.BuyProduct(p.productId)))
                   ,$Html$Attributes.target("_blank")]),
      _L.fromArray([$Html.text(A2($Basics._op["++"],
      "£",
