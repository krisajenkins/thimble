...
Elm.Main.make = function (_elm) {
   ...
   var updateFrontPageSettings = function (_v7) {
      return function () {
         switch (_v7.ctor)
         {case "Model":
   ...
   var pageSize = 24;
   var updatePageSize = function (_v16) {
      return function () {
         switch (_v16.ctor)
         {case "Model":
            return $System.Model(function () {
                 ...
                 {case "_Tuple2":
                    switch (_v19._0.ctor)
                      {case "Just":
                         switch (_v19._1.ctor)
                           {case "ProductListPage":
                              return $System.scrolledToBottom(_v19._0._0) ? _U.replace([["view"
   ...
   var persistedStarredProducts = function () {
      var decodeStarred = function (maybeString) {
         return function () {
            ...
            {case "Just":
               return function () {
                    var _v27 = A2($Json$Decode.decodeString,
   ...
   var decodeHash = function (hash) {
      return function () {
         ...
         productPrefix,
         hash) ? function () {
            var _v45 = $Json$Decode.decodeString($Json$Decode.$int)(A2($Exts$String.removePrefix,
            productPrefix,
            hash));
            switch (_v45.ctor)
            {case "Err":
               ...
               case "Ok":
               return $System.ProductPage(_v45._0);}
            _U.badCase($moduleName,
   ...
   function () {
      ...
      var starred = function (_v67) {
         return function () {
            switch (_v67.ctor)
            {case "Model":
               return _v67._0.starredProducts;}
            _U.badCase($moduleName,
            "on line 96, column 27 to 44");
         }();
      };
...
Elm.View.make = function (_elm) {
   ...
   var debuggingView = function (_v4) {
      return function () {
         switch (_v4.ctor)
         {case "Model":
            return A2($Html.div,
              ...
              _L.fromArray([$Html.text(A2($Basics._op["++"],
                           "View: ",
                           $Basics.toString(_v4._0.view)))
                           ,A2($Html.br,
                           _L.fromArray([]),
                           _L.fromArray([]))
                           ,$Html.text(A2($Basics._op["++"],
                           "FPS: ",
                           $Basics.toString(_v4._0.frontPageSettings)))
                           ,A2($Html.br,
                           _L.fromArray([]),
                           _L.fromArray([]))
                           ,$Html.text(A2($Basics._op["++"],
   ...
   dataFeed) {
      return function () {
         var _v16 = A2($System.lookupProduct,
         productId,
         dataFeed.products);
         switch (_v16.ctor)
         {case "Just":
