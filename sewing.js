...
Elm.Main.make = function (_elm) {
   ...
   var viewport = Elm.Native.Port.make(_elm).inboundSignal("viewport",
   "System.Viewport",
   function (v) {
   ...
   scrollWatch));
   var starredProductsWrite = Elm.Native.Port.make(_elm).outboundSignal("starredProductsWrite",
   function (v) {
      return v.ctor === "Nothing" ? null : v._0;
   },
   function () {
...
Elm.System.make = function (_elm) {
   ...
   var filterProduct = F2(function (starredProducts,
   productFilter) {
      return function () {
         switch (productFilter.ctor)
         {case "FilterNoBrand":
            return function ($) {
                 return $Exts$Maybe.isNothing(function (_) {
                    return _.brandId;
                 }($));
              };
            ...
            return function ($) {
                 return $Set.member(productFilter._0)($Set.fromList(function (_) {
                    return _.categoryIds;
                 }($)));
              };
            case "FilterWithIds":
...
Elm.View.Placement.make = function (_elm) {
   ...
   var placement2 = {ctor: "_Tuple2"
                    ,_0: 468354536
                    ,_1: "\nThis is the best thing in the world. The name, \"Special Occasion\nCape\", makes me realise I need more special occassions in my life,\nand at least one cape to wear for them.\n\nI wonder if I can make one in a coffeecup-themed fabric? I wonder if\nthat would compel coffeeshops to give me free caffeine boosts, as I\nstrode in in my mighty coffeecape?\n"};
